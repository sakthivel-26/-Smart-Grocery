...
export function SalesPage() {
  const { sales, settings, processReturn } = useStore();
      ...
      render: (s: Record<string, unknown>) => {
        ...
        return (
          <div className="flex items-center gap-1">
            ...
            <button onClick={() => generateInvoicePDF(sale, settings)} className="p-1.5 rounded-lg hover:bg-emerald-50 dark:hover:bg-emerald-900/20 text-emerald-600" title="Download PDF"><Download size={14} /></button>
