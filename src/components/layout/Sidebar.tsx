        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-800 min-h-[65px]">
          {sidebarOpen && (
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-primary-500 rounded-lg flex items-center justify-center font-bold text-sm">SG</div>
              <span className="font-bold text-sm whitespace-nowrap">Smart Grocery</span>
            </div>
          )}
